...
public class NativeInterface
{
    ...
    public static  void _OpenCamera()
    {

    }
    public static  void _OpenWeb(string url)
    {

    }
    public static  void _OpenPhoto()
    {

    }
    public static  void _ShowMsgAndQuit(string str, string title, string close)
    {

    }
    public static  void _DownloadNewClient(string str, string title, string url)
    {

    }
    public static  string _GetMac()
    {
        return "test";
    }
    public static  string _GetChannelCode()
    {
        return "test";
    }
    public static  void _SelfPay(string id, string itemID)
    {

    }

    public static  string _IsAppStoreVer()
    {
        return "false";
    }
    public static  void _InitShare(string wxid, string wxpwd, string sinaid, string sinapwd, string qqid, string qqpwd)
    {

    }
    public static  void _BeginShare(string isfriend, string webUrl, string text, string imgUrl)
    {

    }
    public static  void _BeginThirdLogin(string plateform)
    {
